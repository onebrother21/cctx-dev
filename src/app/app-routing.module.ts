...
const routes: Routes = [
  ...
  {path:"cctx",loadChildren: () => import("./cctx-dev").then(m => m.CCTXDevModule)},
  ...
  {path:"**",loadChildren: () => import("./cctx-dev/views/cctx-dev-not-found").then(m => m.CCTXDevNotFoundModule)},
];
