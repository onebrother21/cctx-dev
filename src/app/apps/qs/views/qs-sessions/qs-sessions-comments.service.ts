...
@Injectable()
export class QS_SessionsCommentsService {
  private newComment = new Subject<QS_SessionComment>();
  ...
  addRandomComment(){
    ...
    this.newComment.next(comment as QS_SessionComment);
