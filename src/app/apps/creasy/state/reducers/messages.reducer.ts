...
import { MessagesState,initializeMessages } from "../states";
import { AppError } from "@state";

const initialState = initializeMessages();
...
export function MessagesReducer(s:MessagesState|undefined,action:Action) {return reducer(s,action);}
